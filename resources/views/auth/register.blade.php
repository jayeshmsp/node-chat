                ...
                <div class="panel-body">
                    ...
                    <form class="form-horizontal" role="form" method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group{{ $errors->has($login_with) ? ' has-error' : '' }}">
                            <label for="email" class="col-md-4 control-label">{{ ucfirst($login_with) }}</label>

                            <div class="col-md-6">
                                <input id="{{$login_with}}" type="text" class="form-control" name="{{$login_with}}" value="{{ old($login_with) }}">
